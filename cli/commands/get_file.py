...
class GetFileCommand(CommandSet):
    ...
    get_file_parser.add_argument("--dest", type=str, required=True, help="Ruta de destino en el servidor")
    ...
    def do_get_file(self, args):
        ...
        try:
            ...
            if file_handler.enviar_comando_solicitar_archivo(args.source, args.dest, cliente_id):
                console.print(f"[bold green]Comando enviado: solicitar archivo '{args.source}' hacia '{args.dest}'[/bold green]")
            else:
